...
var cars_Ref = firebase.database().ref('/LAMPARAS_E1vsab');


var dataConductores = firebase.database().ref('/LAMPARAS_E1vsab');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E1sab');
